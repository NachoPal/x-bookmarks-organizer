...
async function boot() {
  ...
  for (const f of ["tree-counts.js", "read-toggle.js", "filter-cache.js", "theme.js", "embed-theme.js", "post-scale.js", "sidebar-state.js", "tree-color.js", "categorization.js", "app.js"]) {
    w.eval(read(f));
  }
